...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xdfdfdfff, 0x000000ff, 0x444444ff },
	[SchemeSel]  = { 0xdfdfdfff, 0x800000ff, 0x800000ff },
...
/* Brightnessctl */
static const char *brightnessup[]   = { "/home/rar/Downloads/brightness_script.sh", "+10%", NULL };
static const char *brightnessdown[] = { "/home/rar/Downloads/brightness_script.sh", "-10%", NULL };
/* smart borders*/
...
/* screenshot */
static const char *screenshotarea[] = { "screenshotarea", NULL };

static const char *screenshotfull[] = { "screenshotfull", NULL };
...
static const Button buttons[] = {
	...
	{ ClkTitle,    0,      BTN_MIDDLE, killclient,     {0} },
	{ ClkStatus,   0,      BTN_MIDDLE, spawn,          {.v = menucmd} },
